...
void comm_neigh_to_bf(Atom &atom, Neighbor &neighbor, Comm &comm, int n){
        ...
        if(isHost){
                ...
                MPI_Send(addresses, 5, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_aint)))), 1, 0, nic_host_communicator);
                ...
                MPI_Recv(addresses, 5, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_aint)))), 0, 0, nic_host_communicator, (static_cast<MPI_Status *> (0)));
