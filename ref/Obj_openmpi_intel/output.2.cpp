...
# 2186 "/usr/include/c++/8/x86_64-redhat-linux/bits/c++config.h" 3
...
# 2208 "/usr/include/c++/8/x86_64-redhat-linux/bits/c++config.h" 3
namespace std
{
...
# 2458 "/usr/include/c++/8/x86_64-redhat-linux/bits/c++config.h" 3
...
# 2459 "/usr/include/c++/8/x86_64-redhat-linux/bits/c++config.h" 2 3


# 1 "/usr/include/c++/8/x86_64-redhat-linux/bits/cpu_defines.h" 1 3
# 2462 "/usr/include/c++/8/x86_64-redhat-linux/bits/c++config.h" 2 3
...
class Force
{
  public:
    ...
    virtual void compute(Atom &, Neighbor &, Comm &, int, int) {};
            ...
            Thermo &thermo, Integrate &integrate, Timer &timer, int screen_yaml)
{
  ...
  MPI_Comm_size((static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))), &nprocs);
  ...
  int natoms;
  MPI_Allreduce(&atom.nlocal, &natoms, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_int)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  ...
  int nlostall;
  MPI_Allreduce(&nlost, &nlostall, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_int)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
...
# 114 "output.cpp" 3 4
             stdout
# 114 "output.cpp"
                   , "  variant: " "miniMD-Reference 2.0 (MPI+OpenMP)" "\n");
      fprintf(
# 115 "output.cpp" 3 4
             stdout
# 115 "output.cpp"
...
# 200 "output.cpp"
  ...
  MPI_Allreduce(&time_total, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
...
# 217 "output.cpp"
  ...
  MPI_Allreduce(&time_force, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  tmp /= nprocs;
...
# 235 "output.cpp"
  ...
  MPI_Allreduce(&time_neigh, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  tmp /= nprocs;
...
# 246 "output.cpp"
  ...
  MPI_Allreduce(&time_comm, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  tmp /= nprocs;
...
# 257 "output.cpp"
  ...
  MPI_Allreduce(&time_other, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  tmp /= nprocs;
...
# 468 "output.cpp"
  ...
  MPI_Allreduce(&tmp, &total, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
           ...
           int nhisto, int* histo)
{
  ...
  int ntotal;
  MPI_Allreduce(&n, &ntotal, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_int)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  double tmp;
  MPI_Allreduce(&ave, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  ave = tmp / ntotal;
  MPI_Allreduce(&min, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_min)))), hosts_communicator);
  min = tmp;
  MPI_Allreduce(&max, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_max)))), hosts_communicator);
  max = tmp;
  ...
  MPI_Allreduce(histo, histotmp, nhisto, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_int)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
