...
MMD_float Thermo::energy(Atom &atom, Neighbor &neighbor, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&e_act, &eng, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  else
    MPI_Allreduce(&e_act, &eng, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
...
# 166 "thermo.cpp"
  ...
  {
    if(sizeof(MMD_float) == 4)
      MPI_Allreduce(&t_act, &t1, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
    else
      MPI_Allreduce(&t_act, &t1, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
...
MMD_float Thermo::pressure(MMD_float t, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&p_act, &virial, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
  else
    MPI_Allreduce(&p_act, &virial, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void *> (&(ompi_mpi_op_sum)))), hosts_communicator);
