...
# 39 "/usr/include/c++/8/bits/std_abs.h" 2 3
...
# 518 "force_eam.cpp"
  ...
  MPI_Bcast(&flag, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_int)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  ...
  MPI_Bcast(&file->mass, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  MPI_Bcast(&file->nrho, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_int)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  MPI_Bcast(&file->drho, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  MPI_Bcast(&file->nr, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_int)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  MPI_Bcast(&file->dr, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  MPI_Bcast(&file->cut, 1, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  mass = file->mass;
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Bcast(file->frho, file->nrho, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  else
    MPI_Bcast(file->frho, file->nrho, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));

  if(me == 0) grab(fptr, file->nr, file->zr);

  if(sizeof(MMD_float) == 4)
    MPI_Bcast(file->zr, file->nr, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  else
    MPI_Bcast(file->zr, file->nr, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));

  if(me == 0) grab(fptr, file->nr, file->rhor);

  if(sizeof(MMD_float) == 4)
    MPI_Bcast(file->rhor, file->nr, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
  else
    MPI_Bcast(file->rhor, file->nr, (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double)))), 0, (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))));
...
void ForceEAM::communicate(Atom &atom, Comm &comm)
{
  ...
  for(iswap = 0; iswap < comm.nswap; iswap++) {
    ...
    if(comm.sendproc[iswap] != me) {
      MPI_Datatype type = (sizeof(MMD_float) == 4) ? (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))) : (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_double))));
      MPI_Sendrecv(comm.buf_send, comm.comm_send_size[iswap], (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), comm.sendproc[iswap], 0,
                   comm.buf_recv, comm.comm_recv_size[iswap], (static_cast<MPI_Datatype> (static_cast<void *> (&(ompi_mpi_float)))), comm.recvproc[iswap], 0,
                   (static_cast<MPI_Comm> (static_cast<void *> (&(ompi_mpi_comm_world)))), (static_cast<MPI_Status *> (0)));
      buf = comm.buf_recv;
